                              ...
                              <div class="row">
                                <div class="col-lg-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="first_name" class="form-control" placeholder="First Name" value="<?php echo $e_first_name;?>">
                                  </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="last_name" class="form-control" placeholder="Last Name" value="<?php echo $e_last_name;?>">
                                  </div>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <input id="contact_no" class="form-control" placeholder="Contact No" value="<?php echo $e_contact_no;?>" type="text">
                                  </div>
                                </div>
                              </div>
